...
(function($) {
  ...
  ItemView = Backbone.View.extend({
    ...
    render: function(){
      $(this.el).html('<button class="btn btn-success box-glow-white-in">'+this.model.get('name')+' '+this.model.get('cals')+'&nbsp; &nbsp; </button>');
  ...
  TrendsView = Backbone.View.extend({
    ...
    render: function() {
      ...
      if (!googCharts) {
        ...
        self.data.addColumn('string','Date');
        self.data.addColumn('number','Calories');
